...
import { AppRouteType, AuthStatusType } from '../const';
...
export const setAuthorization = createAction('requireAuthorization', (authorizationStatus: AuthStatusType) => ({ payload: authorizationStatus }));
