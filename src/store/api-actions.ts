...
import { setOffers, setOffersBackup, setOffersLoadStatus, setFullOffer,
  setFullOfferLoadStatus, setFavOffers, setFavOffersLoadStatus, sortOffers, setError } from './offers-process/offers-process';
